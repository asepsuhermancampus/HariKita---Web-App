...
import { IslamicArabesqueArchSvg } from "@/components/invitation/svg";
    ...
    >
      ...
      <section id="couple" className="py-16 px-6 space-y-12">
        <div className="text-center space-y-1">
          <IslamicArabesqueArchSvg className="w-16 h-16 mx-auto text-amber-600 mb-2 opacity-90" />
        ...
        <div className="bg-white rounded-3xl p-6 shadow-xl border border-emerald-200 space-y-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 py-3 px-4 rounded-full bg-emerald-900 text-white text-xs font-semibold shadow-md hover:bg-emerald-950 transition-colors min-h-[44px]"
            >
            ...
            <AddToCalendarButton
              ...
              description={`Undangan Pernikahan Syar'i di ${activeSession.venueName}. Sesi: ${activeSession.timeSlot}`}
        ...
        <div className="grid grid-cols-2 gap-3">
          {galleryPhotos.map((photo, idx) => (
            <div
              ...
              className={`rounded-2xl overflow-hidden shadow-md border border-white cursor-pointer group ${
        ...
        <div className="space-y-4">
          {giftInfo.banks.map((b, idx) => (
            <LuxuryBankCard
              ...
              qrisImageUrl="https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=HARIKITA-KEBUMEN-ISLAMIC"
            />
          ))}
