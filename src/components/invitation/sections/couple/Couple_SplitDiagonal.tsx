    ...
    <section id="couple" className="py-20 px-4 sm:px-6 relative overflow-hidden">
      <div className="max-w-3xl mx-auto space-y-14">
        ...
        <div className="text-center space-y-3">
          <span
            className="text-xs font-serif uppercase tracking-[0.25em] font-semibold px-4 py-1.5 rounded-full border border-black/10 inline-flex items-center gap-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10 relative">
          ...
          <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full shadow-md bg-white border border-stone-200 items-center justify-center">
            <Heart className="w-5 h-5 text-rose-500 fill-rose-500 animate-pulse" />
          </div>

          {/* Groom Card (Editorial Asymmetric Cut) */}
          <div className="bg-white/85 backdrop-blur-md rounded-3xl p-6 sm:p-7 border border-stone-200/80 shadow-lg space-y-5 hover:-translate-y-1 transition-transform duration-300">
            <div className="relative h-80 w-full rounded-2xl overflow-hidden shadow-inner group">
              ...
              <div className="absolute bottom-4 left-4 text-white">
                <span className="text-[10px] font-serif uppercase tracking-[0.2em] font-semibold bg-black/50 px-3 py-1 rounded-md backdrop-blur-xs">
                  Mempelai Pria
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                Putra dari <strong className="text-stone-800">{groom.father}</strong> &amp;{" "}
              ...
              {groom.instagram && (
                <a
                  ...
                  className="inline-flex items-center gap-2 text-xs font-serif font-semibold px-4 py-2 rounded-full border border-stone-200 hover:bg-stone-50 transition-colors"
          ...
          <div className="bg-white/85 backdrop-blur-md rounded-3xl p-6 sm:p-7 border border-stone-200/80 shadow-lg space-y-5 hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                Putri dari <strong className="text-stone-800">{bride.father}</strong> &amp;{" "}
