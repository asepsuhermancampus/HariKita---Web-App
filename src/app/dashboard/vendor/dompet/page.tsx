        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div className="text-xs text-[#6B5E62] flex items-center gap-1 mb-1">
              ...
              <span>/</span>
              <span className="text-[#4A2E35] font-medium">Dompet Saldo Escrow</span>
            </div>
            <h1 className="font-serif text-2xl sm:text-3xl font-bold text-[#4A2E35]">
              Dompet Saldo & Penarikan Dana
            </h1>
            <p className="text-xs text-[#6B5E62] mt-0.5">
              Pantau jadwal rilis dana rekening bersama (H-3 operasional & H+2 sukses) serta ajukan pencairan ke rekening Anda.
            </p>
          </div>

          <div className="flex items-center gap-2">
            <span className="px-3 py-1.5 rounded-xl bg-emerald-50 text-emerald-800 text-xs font-semibold border border-emerald-200 flex items-center gap-1.5">
