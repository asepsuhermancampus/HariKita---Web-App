...
- [x] **Step 1: Write verification script to test token presence and values**

Create `scripts/verify_tokens.js` to assert that `globals.css` and `tailwind.config.ts` define the official colors and fonts.

- [x] **Step 2: Run verification script to confirm initial failure/discrepancies**
...
- [x] **Step 3: Implement token files and update Tailwind and globals.css**
...
- [x] **Step 4: Run verification script to ensure all tokens pass**
...
- [x] **Step 1: Write asset verification script**
...
- [x] **Step 2: Run verification script to verify it fails initially**

Run: `node scripts/verify_assets_complete.js`  
Expected: FAIL (0 / 136 assets found).

- [x] **Step 3: Implement asset builder script and execute generation**
...
- [x] **Step 4: Run asset verification script to verify all 136 assets pass**
...
- [x] **Step 1: Write manifest verification script**
...
- [x] **Step 3: Implement TypeScript types, JSON manifest, and helper library**
...
- [x] **Step 4: Run test to verify all entries pass**
...
- [x] **Step 1: Write component verification script**
...
- [x] **Step 3: Implement all 15 UI component variants**

Build the 15 components in `src/components/harikita/ui/` with props, accessible button elements, and clean styling.

- [x] **Step 4: Run verification script to verify all components pass**
...
- [x] **Step 1: Implement the showcase page**
...
- [x] **Step 2: Verify page build and HTTP response**
...
- [x] **Step 3: Commit documentation and master verification script**
